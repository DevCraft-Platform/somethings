...
arguments.add_argument("--remove-chat", action="store_true")
...
arguments.add_argument("--dump-chat", action="store_true")
...
if add_contact:
    ...
    chatCore.execute_remove_chat()
elif search:
    chatCore.execute_search_chat()
elif fltr:
    pass
elif list_chats:
    chatCore.execute_list_chats()
elif add_user:
